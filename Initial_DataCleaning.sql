...
SET      Book_Title = SUBSTR(Movie_Adaptation_Seen, 1, 23),
...
UPDATE   `booklists.books_2019`
SET      Book_Title = REPLACE(Book_Title, SUBSTR(Book_Title, -8, 5))
WHERE    Book_Author = "J. K. Rowling" AND Book_Title NOT LIKE "Harry Potter%"
...
UPDATE   `booklists.books_2019`
SET      Book_Genre = CONCAT(Book_Genre, ", Fantasy, Mythology"),
         Book_Theme = CONCAT(Book_Theme, "; 'Metamorphoses'"),
...
SET      Book_Title = REPLACE(Book_Title, "Law", "Laws")
         Original_Title = Book_Title
...
UPDATE   `booklists.books_2020`
SET      Original_Title = REPLACE(Original_Title, "By", "by"),
         Book_Title = Original_Title 
WHERE    Original_Title LIKE "Call Me%"


UPDATE   `booklists.books_2020`
SET      Book_Title = REPLACE(Book_Title, "Ho", "Ha"),
         Original_Title = Book_Title
...
UPDATE   `booklists.books_2020`
SET      Book_Genre = CONCAT(SUBSTR(Book_Genre, 1, 5), ", ", Book_Theme, SUBSTR(Book_Genre, 6, 10))
...
UPDATE   `booklists.books_2021` 
SET      Original_Title = REPLACE(Original_Title, "And", "and"),
         Book_Title = Original_Title 
WHERE    Original_Title LIKE "%Zombies" 


UPDATE   `booklists.books_2021`
SET      Book_Type = CONCAT(SUBSTR(Book_Type, 1, 7), ", Parody Novel, Retelling"),
...
UPDATE  `booklists.books_2021`
SET      Book_Genre = CONCAT(Book_Genre, ", Fantasy, Speculative Fiction"),
...
SET      Book_Genre = SUBSTR(Book_Genre, 1, 12),
         Book_Theme = CONCAT(Book_Theme, ", Survivalist Mormon Family")
...
UPDATE   `booklists.books_2022`
SET      Book_Type = CONCAT(Book_Type, ", Retelling"),
         Book_Genre = CONCAT("Fantasy, ", Book_Genre),
         Book_Theme = CONCAT(Book_Theme, ", War Story; 'Iliad'")
WHERE    Book_Title = "The Silence of the Girls"


UPDATE  `booklists.books_2022`
SET      Book_Genre = CONCAT(Book_Genre, ", Mystery, Young Adult")
WHERE    Book_Title IN ("The Night Tiger", "The Ghost Bride")


UPDATE  `booklists.books_2022`
SET      Book_Theme = CONCAT("Colonialism, ", Book_Theme, ", Superstition; British Malaya (1931)")
